...
<script language="javascript">
    ...
    .on('click',"#show",function(){
        ...
        //each문  사용//
        //each 문은 input type 이 체크박스인 것에대해  하나하나 실행한다 (for문과비슷함)//
        //each 는 all과 같음 //
        //.each 는 익명함수라고 한다//
        /*each 와 스위치문을 사용해서 쓸때//
        var str='';
       ...
       //객체를 이용하는 방법//
       //1.객체를 먼저선언해준다//
       var interest={'movie':'영화','sports':'스포츠','travel':'여행','enter':'연예',
       'politics':'정치','economy':'경제'};
       var str="";
       //아이디를 뽑아와서 그 값을 str에 붙여준다.
       $('input:checkbox:checked').each(function(){
           //객체에서 값을 가져오려면 배열처럼 인덱스를 입력하는것이 아닌 키 값을 입력한다 (key)//
           //ex movie : 영화//
           //movie 는 key 이고 영화는 value 이다//
           //객체는 key를이용해서 찾을수있고 배열은 인덱스를 이용해서 찾을수있다//
